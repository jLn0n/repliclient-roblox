--[[
	from: https://github.com/uniquadev/LuauVM

	merged by jLn0n
--]]

-- imports
local stream = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/uniquadev/LuauVM/master/VM/stream.lua"))()

local bytecode = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/uniquadev/LuauVM/master/VM/luau/bytecode.lua"))()
local lbuiltins = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/uniquadev/LuauVM/master/VM/luau/lbuiltins.lua"))()
local lobject = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/uniquadev/LuauVM/master/VM/luau/lobject.lua"))()
-- modules
local lvmload, lvmexecute
-- lvmload.lua
